...
func (s *Service) AccountReportPeer(ctx context.Context, request *mtproto.TLAccountReportPeer) (*mtproto.Bool, error) {
	...
	c.Logger.Debugf("account.reportPeer - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.reportPeer - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountReportProfilePhoto(ctx context.Context, request *mtproto.TLAccountReportProfilePhoto) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.reportProfilePhoto - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.reportProfilePhoto - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReportSpam(ctx context.Context, request *mtproto.TLMessagesReportSpam) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.reportSpam - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.reportSpam - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReport(ctx context.Context, request *mtproto.TLMessagesReport) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.report - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.report - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReportEncryptedSpam(ctx context.Context, request *mtproto.TLMessagesReportEncryptedSpam) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.reportEncryptedSpam - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.reportEncryptedSpam - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) ChannelsReportSpam(ctx context.Context, request *mtproto.TLChannelsReportSpam) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("channels.reportSpam - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("channels.reportSpam - reply: %s", r.DebugString())
	return r, err
}
